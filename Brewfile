...
brew "zoxide"
# Unified Starship prompt module for Git and Jujutsu repositories
brew "dmmulroy/tap/jj-starship", trusted: true
...
cargo "typst-cli"
cargo "typst-package-check", source: "https://github.com/typst/package-check.git"
cargo "tytanic"
uv "copier", with: ["copier-template-extensions"]
uv "prek"
uv "zensical", with: ["markdown-callouts"]
